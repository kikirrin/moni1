        ...
        <div data-role="page" id="page" data-title="Monitoreo de medios">
            ...
            <div data-role="content">
                <form action="" method="post" id="form"  data-theme="b">
                    ...
                    <?php if ($Nota['Media'] != "") { ?>
                        <?php if ($Nota['MediaTipo'] == "mp3") { ?>
                            <br> <center><audio id="<?php echo "VideoNota" . $Nota['id']; ?>" preload="auto" controls="controls" src="http://monitoreo.morelos.gob.mx/admin/_lib/file/docarchivos_tv/<?php echo $Nota['Media']; ?>"></audio></center>

                        <?php } else { ?>
                            <br> <center><video id="<?php echo "VideoNota" . $Nota['id']; ?>" preload="auto" controls="controls" src="http://monitoreo.morelos.gob.mx/admin/_lib/file/docarchivos_tv/<?php echo $Nota['Media']; ?>"></video></center>
